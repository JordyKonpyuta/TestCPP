...
UCLASS(config=Game)
class ATestCppUnrealCharacter : public ACharacter , public IInteractInterface
{
	GENERATED_BODY()
...
public:
	...
	FORCEINLINE class UPhysicsHandleComponent* GetPhysicsHandleComponent() const { return PhysicsHandlerComp; }
