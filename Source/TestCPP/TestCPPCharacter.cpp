...
void ATestCppUnrealCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATestCppUnrealCharacter::Move);
...
void ATestCppUnrealCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestCppUnrealCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestCppUnrealCharacter::Grab(const FInputActionValue& Value)
{
	...
	if (Hit.bBlockingHit)
	{
		...
		IInteractInterface::Execute_Grab(Hit.GetActor(),this);
